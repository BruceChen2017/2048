            ...
            traversals.yOrder.forEach(
                function (y) {
                    ...
                    if (tile) {
                        ...
                        // `!next.mergedFrom` means: e.g. consider one sequence 2-4-2-2 with direction `->`, then merge result would be 2-4-4, not 2-8!
        ...
        for (var y = 0; y < this.size; y++) {
            ...
            for (var dir = 0; dir < 4; dir++) {
                ...
                if (this.grid.withinBound(newCell)) {
                    if (this.grid.cells[x][y].value === this.grid.cells[newCell.x][newCell.y].value) {
                        return true;
                    }
                }
            }
